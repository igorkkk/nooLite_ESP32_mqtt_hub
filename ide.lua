...
NodeMCU modules dependencies:
    ...
    mDNS exclamation
--]]
--print('Start Timer to Reboot at 10 min!')
--tmr.create():alarm(600000, 0, function() print('Restart by Timer'); node.restart() end)
...
wifi.sta.on("got_ip", function(ev, info)
  wifi.sta.on("got_ip", nil)
  print("NodeMCU Got IP:", info.ip, 'Start IDE now!')
  editor()
end)
wifi.sta.connect()
